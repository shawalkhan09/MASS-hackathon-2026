...
- The Auditor agent performs exactly 3 checks, not 2.
- Any code, documentation, or comments describing the Auditor's checks must reflect all 3 checks.
- FLAG any place that says or implies the Auditor has only 2 checks.
