# Fidelity check n=9 -- category_renamed -- Check B -- Trial 5/9
...
Instances found: 
* Diagnosis: "**Measurement:** Failure to heed previous warnings from the Southwest Airlines Pilots Association..."
* Report: "**Management:** Failure to heed previous warnings from the Southwest Airlines Pilots Association..."
* Status: This is a PRIMARY cause-classification change (FAIL). The diagnostic label 'Measurement' was replaced with 'Management' in the Fishbone diagram.
...
*   **Management:** Failure to heed previous warnings from the Southwest Airlines Pilots Association regarding the "duct tape" nature of IT infrastructure.
