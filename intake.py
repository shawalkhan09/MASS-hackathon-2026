...
INTAKE_DESCRIPTION = (
    ...
    "supports. And if the user describes two facts in sequence without "
    "stating that one caused the other, do not assert a causal link "
    "between them (\"as a result,\" \"consequently\") -- list them as "
    "the separate facts given, not as a cause and its effect.\n\n"
